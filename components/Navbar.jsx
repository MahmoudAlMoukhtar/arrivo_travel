        ...
        <nav className="flex justify-between items-center py-[12px] gap-[17px]">
          <div className="flex-1 flex justify-between items-center">
            ...
            <div className="hidden md:flex gap-x-4 md:gap-x-[20px] items-center relative  text-left">
              <div
                className={`absolute z-10 top-[60px] mt-2 right-[-200px]  lg:right-[-100px]   rounded-md bg-white shadow-lg p-[32px]  ${
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-grey text-[12px]">
                        نقدم مغامرات ملهمة وتجارب مصممة بعناية لكل عميل، مع
                        تخطيط متفوق وتنظيم محكم لضمان تجربة سفر لا تُنسى.
                      </p>
                    </motion.div>
                    <motion.div
                      variants={serviceVariants}
                    ...
                    >
                      ...
                      <p className="text-grey text-[12px]">
                        استمتع برحلات يومية مع سائق خاص لزيارة وجهات رائعة
                        وأماكن غير مكتشفة. مستشارون محترفون لتنظيم مسارات
                        متناسقة توفر تجربة مريحة وممتعة بأقل جهد ووقت.
                      </p>
                    </motion.div>
                    <motion.div
                      variants={serviceVariants}
                    ...
                    >
                      ...
                      <p className="text-grey text-[12px]">
                        تأجير سيارات مرن وآمن, اختيارات متنوعة، توصيل مريح،
                        لتجربة سفر لا مثيل لها.
                      </p>
                    </motion.div>
                  </motion.div>
                </div>
              ...
              <Link href="/contact">
                <div className="text-[#636973] text-[12px] lg:text-[14px] hover:text-deep flex items-center gap-[1px]">
                  البرامج السياحية
              ...
              >
                <div className="text-[#636973] text-[12px] lg:text-[14px] hover:text-deep flex items-center">
                  الخدمات
                  <Image
                    alt="/"
            ...
            <div className="hidden md:flex gap-x-2 items-center h-[48px] bg-white rounded-[40px] border border-[#C8CBD0] py-[12px] px-[6px] lg:pt-[10x] lg:px-[10px] lg:pr-[16px]">
              <input
                type="text"
                className="border-0 outline-none bg-transparent flex-1 text-[12px] lg:text-[16px]"
