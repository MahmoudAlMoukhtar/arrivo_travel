const PriceDetails = ({details}) => {
  ...
  return (
    <div className="flex items-start gap-[48px] flex-wrap lg:flex-nowrap mb-[48px]">
      <div className="flex flex-col gap-[20px]">
        <div className="flex justify-start items-center gap-[11px]">
          ...
          <span className="text-[24px] font-bold">الشعر يشمل</span>
        </div>
        <div className="flex flex-col gap-[20px]">
          {includes.map((d, i) => (
      ...
      <div className="flex flex-col gap-[20px]">
        <div className="flex justify-start items-center gap-[11px]">
          ...
          <span className="text-[24px] font-bold">الشعر لا يشمل</span>
        </div>
        <div className="flex flex-col gap-[20px]">
